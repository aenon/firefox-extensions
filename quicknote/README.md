...
This project is forked from [webextensions-examples](https://github.com/mdn/webextensions-examples)/[Quicknote](https://github.com/mdn/webextensions-examples/tree/master/quicknote), rewritten with ES6.
...
* A browser action that creates a popup — within the popup is:
	* Two form elements for entering title and body text for a new note, along with a button to add a note, and a button to clear all notes. The __title__ is now optional.
